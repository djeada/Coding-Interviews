...
cartesianProductRecursive(const std::vector<std::vector<int>> &input) {
  std::vector<std::vector<int>> results;
  std::vector<int> current;
...
// --- Iterative solution ---
std::vector<std::vector<int>>
cartesianProductIterative(const std::vector<std::vector<int>> &input) {
...
int main() {
  std::vector<TestCase> cases = {
      ...
      {"All singletons", {{6}, {7}, {8}, {9}}, {{6, 7, 8, 9}}},
