...
bool findCore(vector < vector<int> > matrix, int value, int row1, int col1, int row2, int col2){
...
void test(const string &testName, vector < vector<int> > matrix, int value, bool expected){
...
void test7(){
	vector<vector<int> > matrix{{1, 2, 8, 9, 14, 15}, {2, 4, 9, 12, 16, 23}, {4, 7, 10, 13, 21, 25}, {6, 8, 11, 15, 23, 27}};
...
void test8(){
        vector<vector<int> > matrix{{1, 2, 8, 9}, {2, 4, 9, 12}, {4, 7, 10, 13}, {6, 8, 11, 15}, {8, 10, 13, 20}, {12, 13, 17, 25}, {19, 22, 25, 30}};
